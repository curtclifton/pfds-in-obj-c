...
public protocol Stack: Equatable {
    // CCC, 10/31/2015. Should be named Element
    ...
    func cons(element: ElementType) -> Self
    ...
    func append<OtherStack: Stack where OtherStack.ElementType == ElementType>(otherStack: OtherStack) -> OtherStack
...
public func -|-<Element, S: Stack where S.ElementType == Element>(element: Element, stack: S) -> S {
